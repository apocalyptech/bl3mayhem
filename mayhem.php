...
$default_config = array(
    ...
    's' => array(
        array(2.0, 0.2, 0.2, 1.0, 1.625, 1.3125),
        array(4.0, 0.4, 0.4, 3.0, 2.25, 1.625),
        array(6.0, 0.6, 0.6, 5.0, 2.875, 1.9375),
        array(8.0, 0.8, 0.8, 7.5, 3.5, 2.25),
        array(15.0, 1.0, 1.0, 10.0, 4.125, 2.5625),
        array(30.0, 1.2, 1.2, 13.0, 4.75, 2.875),
        array(45.0, 1.4, 1.4, 16.0, 5.375, 3.1875),
        array(60.0, 1.6, 1.6, 19.0, 6.0, 3.5),
        array(80.0, 1.8, 1.8, 22.0, 6.625, 3.8125),
        array(100.0, 2.0, 2.0, 25.0, 7.25, 4.125),
        array(100.0, 1.0, 1.0, 12.5, 7.25, 4.125),
        ),
    );
